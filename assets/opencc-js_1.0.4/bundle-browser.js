(function (global, factory) {
  ...
  /**
   * allVar2StdByChar 是把所有异体字先转为标准字（标准字是繁体字）；并且不使用词语转换。
   * std2SimpleByChar 是把繁体字转为简体；并且不使用词语转换。
   */
  const variants2standard = {
    ...
    allVar2StdByChar: ['JPVariantsRev', 'JPShinjitaiCharacters','TWVariantsRev','HKVariantsRev'],
  };
